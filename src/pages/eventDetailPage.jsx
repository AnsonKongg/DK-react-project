    ...
    <>
      {eventDetail && (
        <div className="row-container">
          <div className="card">
            <b className="card-title">{eventDetail.title}</b>
            ...
            <Row className="card-host-container" align="middle">
              <Avatar
                size="large"
                src={eventDetail?.host?.profile_picture_url}
              />
          ...
          <div className="card-small">
            ...
            <Row className="card-padding" justify="center">
              <div style={{ width: "27vw", height: "30vh", position: "relative" }}>
                <Map
                  style={{
                    width: "27vw",
                    height: "30vh",
...
const EventDetailMap = GoogleApiWrapper({
  apiKey: "AIzaSyDvTMDijyU_BgWn5MvBoCOHL8Yn1H3hVGQ",
